...
The APIs have been promoted from experimental to General Availability, achieving feature-completeness and parity with Java. Old C{plus}{plus} APIs will be decommissioned in *1.50.0*.
