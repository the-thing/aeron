...
* **[Consensus Module]** The classes RecordingLog.Snapshot, RecordingLog.Log and Recording.RecoveryPlan have been changed from flat classes to records, so the data accessors are now methods and not fields.
