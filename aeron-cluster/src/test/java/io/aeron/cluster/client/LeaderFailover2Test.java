...
class LeaderFailover2Test {
    ...
    void testClientClusterDownDetection() {
        ...
        MediaDriver.Context mediaDriverContext = cluster.newClientMediaDriverContext();

        try (MediaDriver driver = MediaDriver.launch(mediaDriverContext)) {
            Aeron.Context aeronContext = new Aeron.Context()
                    .driverTimeoutMs(TimeUnit.SECONDS.toNanos(1L))
            ...
            AeronCluster.Context clientContext = cluster.clientCtx().
                    ...
                    messageTimeoutNs(TimeUnit.SECONDS.toNanos(1L)).
